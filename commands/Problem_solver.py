...
"""Problem_solver — define solvers and settings (problem.solver(Solver.CRA(...) / LMGC90(...) / ...)); running is done by the Solve command
...
def RunCommand():
    ...
    warn("Problem_solver: not implemented yet.")
